...
namespace ContosoUniversity.Controllers
{
    public class InstructorController : Controller
    {
        ...
        /*
         * Abaixo se encontra o index original.
         * Foi alterado para que implementasse a \ViewModel de InstrutorIndexData.
         * */
                ...
                "LastName", "FirstMidName", "HireDate", "OfficeAssignment" }))
            {
                ...
                catch(RetryLimitExceededException /* dex */)
                {
                    ...
                    ModelState.AddModelError("", "Unable to save changes. Try again, and if the " +
                        "probelm persists, see your system administrator.");
                }
            }
